...
async def kashoo_sidebar(ctx, **kwargs) -> ui.UINode:
    return ui.Stack(
        ...
        align="stretch",
        children=[
            ui.Text("Kashoo", variant="heading"),
            ui.Stack(
                direction="v",
                gap=1,
                align="stretch",
                children=[
                    ui.Text("Manage your Kashoo connections and integrations.", variant="caption"),
                ]
            ),
            ui.Divider(),
            ui.Stack(
                                ...
                                children=[
                                    ...
                                    ui.Stack(
                                        ...
                                        children=[
                                            ...
                                            ui.Input(param_name="label", placeholder="e.g. Production Kashoo"),
                                        ]
                                    ),
                                    ui.Stack(
                                        direction="v",
